...
angular.module('myApp', ['ngResource', 'individualListServices', 'biometricServices', 'ui.bootstrap', 'google-chart'])
	.config(function($routeProvider) {
	    ...
	    $routeProvider.
		    ...
		    when('/bluetest', {controller:individualListCtrl, templateUrl:'bluetest2.html'}).
