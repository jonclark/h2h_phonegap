	...
	public PluginResult execute(String action, JSONArray args, String callbackId) {
		...
		if (m_bluetoothAdapter == null) {
			...
			// Connect to a given device & uuid endpoint
				...
				pluginResult = new PluginResult(PluginResult.Status.INVALID_ACTION, "Action '"
	...
	private class BPBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			// Check if we found UUIDs
				...
				Parcelable[] parcelUuids = intent
						.getParcelableArrayExtra(BluetoothPlugin.EXTRA_UUID);
				if (parcelUuids != null) {
